  ...
  class CLI::Application < CLI::Core
    ...
    def generate_docker_config
      ...
      base_templates = {
        ...
        "docker/nginx/.dockerignore" => "docker/nginx/.dockerignore",
        "docker/nginx/.gitignore" => "docker/nginx/.gitignore",
        "docker/nginx/Dockerfile" => "docker/nginx/Dockerfile",
        "docker/nginx/nginx.tmpl" => "docker/nginx/nginx.tmpl",
        "docker/upstart" => "docker/upstart",
        "script/build" => "script/build",
        "script/build_prod" => "script/build_prod",
        ...
        "script/generate_admin_assets" => "script/generate_admin_assets",
        "script/git-revision" => "script/git-revision",
